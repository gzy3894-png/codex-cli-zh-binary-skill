...
assert_file_contains "$tmp/import-home/.codex/sessions/session.jsonl" "$new_prefix/files/home"
assert_file_contains "$tmp/import-home/.codex/sessions/session.jsonl" "/data/data/$new_pkg/files"
assert_file_contains "$import_fs_prefix/shared_prefs/settings.xml" "$new_prefix"
assert_file_contains "$import_fs_prefix/local/browser/status" "$new_pkg"
...
[ -s "$tmp/import-home/.codex/auth.json" ] || fail "auth.json should be transferred as state"
