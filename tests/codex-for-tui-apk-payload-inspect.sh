...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.5.22}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-88}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.5.22" ] || fail "unexpected runtime epoch"
