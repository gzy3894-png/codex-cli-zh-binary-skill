...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.5.23}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-89}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.5.23" ] || fail "unexpected runtime epoch"
