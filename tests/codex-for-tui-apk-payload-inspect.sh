...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.5.8}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-74}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.5.8" ] || fail "unexpected runtime epoch"
