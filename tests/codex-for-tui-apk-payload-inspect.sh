...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.5.4}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-70}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.5.4" ] || fail "unexpected runtime epoch"
