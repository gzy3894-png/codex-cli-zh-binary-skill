...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.4.9}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-64}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.4.9" ] || fail "unexpected runtime epoch"
