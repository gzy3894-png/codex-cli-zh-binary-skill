...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.4.2}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-57}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.4.2" ] || fail "unexpected runtime epoch"
