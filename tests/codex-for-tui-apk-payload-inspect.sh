...
APK="${1:-}"
EXPECTED_RELEASE="${CODEX_TUI_EXPECTED_VERSION_NAME:-2.5.24}"
EXPECTED_VERSION_CODE="${CODEX_TUI_EXPECTED_VERSION_CODE:-90}"
...
[ "$(manifest_value runtime_epoch)" = "apk-2.5.24" ] || fail "unexpected runtime epoch"
